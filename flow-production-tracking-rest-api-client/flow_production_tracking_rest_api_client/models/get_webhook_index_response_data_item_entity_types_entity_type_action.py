...
T = TypeVar("T", bound="GetWebhookIndexResponseDataItemEntityTypesEntityTypeAction")


@_attrs_define
class GetWebhookIndexResponseDataItemEntityTypesEntityTypeAction:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_webhook_index_response_data_item_entity_types_entity_type_action = cls(
            field_name=field_name,
        )

        get_webhook_index_response_data_item_entity_types_entity_type_action.additional_properties = d
        return get_webhook_index_response_data_item_entity_types_entity_type_action
