...
T = TypeVar("T", bound="CreateWebhookRequestEntityTypesEntityTypeAction")


@_attrs_define
class CreateWebhookRequestEntityTypesEntityTypeAction:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_webhook_request_entity_types_entity_type_action = cls(
            field_name=field_name,
        )

        create_webhook_request_entity_types_entity_type_action.additional_properties = d
        return create_webhook_request_entity_types_entity_type_action
