...
if TYPE_CHECKING:
    from ..models.webhook_record_response_data_entity_types import WebhookRecordResponseDataEntityTypes


T = TypeVar("T", bound="WebhookRecordResponseData")


@_attrs_define
class WebhookRecordResponseData:
    """
    Attributes:
        ...
        entity_types (Union[Unset, WebhookRecordResponseDataEntityTypes]): The filters for the webhook base on entity
            types and action. **Note that even though 'entity_types' is plural, only a single entity type is currently
            supported.**
    ...
    entity_types: Union[Unset, "WebhookRecordResponseDataEntityTypes"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entity_types: Union[Unset, WebhookRecordResponseDataEntityTypes]
        if isinstance(_entity_types, Unset):
            entity_types = UNSET
        else:
            entity_types = WebhookRecordResponseDataEntityTypes.from_dict(_entity_types)
        ...
        webhook_record_response_data = cls(
            id=id,
        ...
        webhook_record_response_data.additional_properties = d
        return webhook_record_response_data
