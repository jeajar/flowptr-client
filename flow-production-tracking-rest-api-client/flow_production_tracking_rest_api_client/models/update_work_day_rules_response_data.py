...
T = TypeVar("T", bound="UpdateWorkDayRulesResponseData")


@_attrs_define
class UpdateWorkDayRulesResponseData:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_work_day_rules_response_data = cls(
            date=date,
            working=working,
        ...
        update_work_day_rules_response_data.additional_properties = d
        return update_work_day_rules_response_data
