...
from ..models.post_field_upload_body_upload_info_storage_service import PostFieldUploadBodyUploadInfoStorageService
from ..models.post_field_upload_body_upload_info_upload_type import PostFieldUploadBodyUploadInfoUploadType
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostFieldUploadBodyUploadInfo")


@_attrs_define
class PostFieldUploadBodyUploadInfo:
    ...
    Attributes:
        timestamp (str): The ISO 8601 timestamp of this request. Used in the complete request to set the created_at
            value of the upload.
        upload_type (PostFieldUploadBodyUploadInfoUploadType): The type of upload that the server has determined this
            request is for.
        ...
        storage_service (PostFieldUploadBodyUploadInfoStorageService): The location of there the file will be uploaded.
    ...
    timestamp: str
    upload_type: PostFieldUploadBodyUploadInfoUploadType
    upload_id: str
    storage_service: PostFieldUploadBodyUploadInfoStorageService
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        upload_type = PostFieldUploadBodyUploadInfoUploadType(d.pop("upload_type"))

        upload_id = d.pop("upload_id")

        storage_service = PostFieldUploadBodyUploadInfoStorageService(d.pop("storage_service"))
        ...
        post_field_upload_body_upload_info = cls(
            timestamp=timestamp,
            upload_type=upload_type,
            upload_id=upload_id,
            storage_service=storage_service,
        ...
        post_field_upload_body_upload_info.additional_properties = d
        return post_field_upload_body_upload_info
