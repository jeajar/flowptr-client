...
T = TypeVar("T", bound="UpdateWebhookRequestEntityTypesEntityTypeAction")


@_attrs_define
class UpdateWebhookRequestEntityTypesEntityTypeAction:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_webhook_request_entity_types_entity_type_action = cls(
            field_name=field_name,
        )

        update_webhook_request_entity_types_entity_type_action.additional_properties = d
        return update_webhook_request_entity_types_entity_type_action
