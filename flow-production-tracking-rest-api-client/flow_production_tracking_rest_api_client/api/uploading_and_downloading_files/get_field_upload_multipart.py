...
from ...models.get_field_upload_multipart_upload_type import GetFieldUploadMultipartUploadType
...
def _get_kwargs(
    ...
    *,
    filename: str,
    upload_type: GetFieldUploadMultipartUploadType,
    timestamp: str,
    upload_id: str,
    part_number: int,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/entity/{entity}/{record_id}/{field_name}/_upload/multipart",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        field_name (str):
        filename (str):
        upload_type (GetFieldUploadMultipartUploadType): The type of upload that the server has
